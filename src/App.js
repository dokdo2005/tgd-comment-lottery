...
import { Spinner, Button, Col, Form, Row, ListGroup, Container } from 'react-bootstrap';
      ...
      <Container>
          <Row>
            <Col>
              <Row>
                <Col xs={10}>
                  <Form.Control ref={boardUrlRef} placeholder={'게시물 주소 입력'} onChange={() => setBoardUrl(boardUrlRef.current.value)} />
                </Col>
                <Col>
                  <Button onClick={() => getCommentList(boardUrl)}><FontAwesomeIcon icon={faFileDownload} /></Button>
                </Col>
              </Row>
              <Row>
